...
class generate_groups:
    ...
    def __init__(self, Initial_population_size, number_of_selfish_traits, Number_of_groups, proportion_of_selfish_traits_dictionary):
    ...
    def generate_list_of_individuals(self):
        for k in proportion_of_selfish_traits_dictionary:
            number_of_individuals = round(proportion_of_selfish_traits_dictionary[k] * self.Initial_population_size)
...
g1 = generate_groups(20, 2, 4, proportion_of_selfish_traits_dictionary)
