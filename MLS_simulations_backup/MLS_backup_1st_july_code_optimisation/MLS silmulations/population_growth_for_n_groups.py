...
class population_growth_for_n_groups_class:
        def __init__(self, parameters_object, initial_list_of_groups_for_calulating_population_growth_over_time):
        ...
        def population_growth_of_n_groups_over_time(self):
            ...
            for group_number in range(len(self.initial_list_of_groups_for_calulating_population_growth_over_time)):
                self.population_growth_for_group_instance.finding_population_dictionaries_over_time(self.initial_list_of_groups_for_calulating_population_growth_over_time[group_number])

                #calculate group dictionary for
                group_dictionary_after_n_generations = self.population_growth_for_group_instance.finding_population_dictionary_at_the_end_of_n_generations()
        ...
        def find_pooled_groups_dictionary(self):
             ...
             # print("population_dictionary_after_pooling", self.population_dictionary_after_pooling)
