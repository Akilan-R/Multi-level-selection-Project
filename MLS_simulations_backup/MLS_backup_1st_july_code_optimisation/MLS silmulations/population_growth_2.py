...
class population_growth_for_group_class():
    ...
    # def finding_population_dictionaries_over_time(self, group_dictionary_at_beginning_of_cycle):      #finding_group_dictionary_
    #
    #     start_time = timer()
    #
    ...
    #     # self.group_dictionaries_over_time_list = np.array([group_dictionary_at_beginning_of_cycle])
    #
    #     self.group_dictionaries_over_time_list = np.zeros(self.parameters_object.number_of_generations)
    #     self.group_dictionaries_over_time_list[0] = group_dictionary_at_beginning_of_cycle
    #
    ...
    #
    #         self.group_dictionaries_over_time_list[t] =  group_dictionary_at_next_generation_in_pop_dict_over_time
    ...
    #
    #     print("the new time taken is", timer() - start_time)
    #
    #     return self.group_dictionaries_over_time_list
    #

    def time_taken_function(self):

        print(timeit.timeit('''finding_population_dictionaries_over_time())'''))
    ...
    def finding_population_dictionaries_over_time(self, group_dictionary_at_beginning_of_cycle):
        ...
        print("the new versions time taken is", timer() - start_time1)

        return self.group_dictionaries_over_time_list

    def finding_population_dictionaries_over_time_old(self, group_dictionary_at_beginning_of_cycle):
        ...
        print("the old time taken is", timer() - start_time2)


        return group_dictionary_at_given_generation_in_pop_dict_over_time
