...
class fitness_of_group_class:
    ...
    def find_effect_on_group_fitness_due_to_trait(self, trait_temp):
        C_value = self.C_value_dictionary[trait_temp]
...
def find_realised_fitness_function_1(C_value, K1_value, C_value_dictionary, group_population_dictionary_at_given_time, K2_value):
