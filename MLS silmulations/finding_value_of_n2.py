...
class generate_groups:
    ...
    def __init__(self, parameters_object , proportion_of_selfish_traits_dictionary):
        ...
        self.sum_of_squares_dictionary = {}
        self.combined_list_of_groups_in_compact_form_array = np.zeros(1)
    ...
    def convert_groups_to_compact_form(self):
        ...
        self.combined_list_of_groups_in_compact_form_array = np.array(combined_list_of_groups_in_compact_form)
        ...
        print(self.combined_list_of_groups_in_compact_form_array)
        return self.combined_list_of_groups_in_compact_form_array

    def calculate_value_of_sum_of_number_of_individuals_2(self):

        sum_of_individuals_with_trait_C1_square = 0
        for group_in_group_list_to_be_pooled in self.combined_list_of_groups_in_compact_form_array:
            # print(number_of_individuals_with_trait, "number_of_individuals_with_trait")
            sum_of_individuals_with_trait_C1_square += (group_in_group_list_to_be_pooled["C1"] ** 2)

        self.sum_of_squares_dictionary["C1"] = sum_of_individuals_with_trait_C1_square

        sum_of_individuals_with_trait_C2_square = 0
        for group_in_group_list_to_be_pooled in self.combined_list_of_groups_in_compact_form_array:
            # print(number_of_individuals_with_trait, "number_of_individuals_with_trait")
            sum_of_individuals_with_trait_C2_square += (group_in_group_list_to_be_pooled["C2"]**2)

        self.sum_of_squares_dictionary["C2"] = sum_of_individuals_with_trait_C2_square


        print("sum_of_squares_dictionary", self.sum_of_squares_dictionary)
...
g1.calculate_value_of_sum_of_number_of_individuals_2()
